...
router.get(
  '/question/simulated/:amount',
  ensureAdmin,
  questionController.getSomeSimulatedQuestions,
);
router.get(
  '/question/topic/:topic',
  ensureAdmin,
  questionController.getQuestionsOfTopic,
);
...
router.post(
  '/send/welcome/email',
  ensureAdmin,
  sendEmailController.sendCreateUserMessage,
);
// ***********
//  files
// ***********
...
router.get(
  ...
  ensureAuthenticated,
  answerController.getAnswerByUserTopic,
);
